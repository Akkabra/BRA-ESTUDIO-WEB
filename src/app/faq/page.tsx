    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground cyber-grain">
      ...
      <main className="flex-1 flex items-center justify-center p-4 pt-24 sm:pt-20">
        <motion.div 
            ...
            animate="visible"
        >
          <div className="mb-6 flex justify-center items-center gap-3 sm:gap-4">
          ...
          <p className="text-sm sm:text-base text-text-desaturated mb-8 font-body">
          ...
          <div className="min-h-[150px] w-full bg-surface-dark/80 border border-neon-yellow/20 rounded-lg p-4 sm:p-6 text-left font-code text-neon-yellow shadow-neon-subtle text-sm sm:text-base">
            {isLoading ? (
